...
grid$numRecords <- (grid$numRecords/max(grid$numRecords,na.rm = TRUE))*5
grid$sppRichness <- (grid$sppRichness/max(grid$sppRichness,na.rm = TRUE))*5
grid$genRichness <- (grid$genRichness/max(grid$genRichness,na.rm = TRUE))*5
grid$subfamRichness <- (grid$subfamRichness/max(grid$subfamRichness,na.rm = TRUE))*5
```
